...
class Router extends Component {
	...
	async routeTo(url) {
		...
		if (header !== null) {
			if (url === '\/')
				header.className = "col-md-offset-4 col-md-4 animated animated_fastest fadeOutRight"
			else
				header.className = "col-md-offset-4 col-md-4 animated animated_fastest fadeOutLeft"
			this.timeout = setTimeout(() => {
				if (url === '\/')
					header.className = "col-md-offset-4 col-md-4 animated animated_fastest fadeInLeft"
				else
		...
		if (content !== null) {
			if (url === '\/')
				content.className = "col-md-offset-4 col-md-4 animated animated_fastest fadeOutRight"
			else
				content.className = "col-md-offset-4 col-md-4 animated animated_fastest fadeOutLeft"
			this.timeout = setTimeout(() => {
				if (url === '\/')
					content.className = "col-md-offset-4 col-md-4 animated animated_fastest fadeInLeft"
				else
					content.className = "col-md-offset-4 col-md-4 animated animated_fastest fadeInRight"
				this.timeout = setTimeout(() => {
